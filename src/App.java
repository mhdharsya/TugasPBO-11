    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            if (metodePembayaran.isEmpty()) {
                faktur = new faktur(nomorFaktur, namaPelanggan, nomorHp, namaBarang, hargaBarang, jumlahBeli);
            } else {
                faktur = new fakturOnline(nomorFaktur, namaPelanggan, nomorHp, namaBarang, hargaBarang, jumlahBeli, metodePembayaran);
            }
